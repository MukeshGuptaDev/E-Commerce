...
import { BiMdMailUnread, BiSupport, BiSolidPhoneCall } from "react-icons/bi";

const Contact = () => {
    return (
        <Layout title={"Contactus E-Commerce-App"}>
                ...
                <div className="container">
                    <div className="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
                        <div className="col-12 col-lg-6">
                            <img className="img-fluid rounded" loading="lazy" src="/Images/Natural.jpg" alt="contactus" style={{ width: "100%" }} />
                        </div>
                        <div className="col-12 col-lg-6">
                                ...
                                <div className="col-12 col-xl-11">
                                    ...
                                    <div className="d-flex mb-4">
                                        ...
                                        <div>
                                            ...
                                            <a href="https://www.google.com/maps/place/Phulmati+bhawan/@24.8196518,84.3750102,17.58z/data=!4m16!1m9!3m8!1s0x398d02695712e759:0xe4e8fcd215e2a079!2sPiraunta,+Bihar+824121!3b1!8m2!3d24.819761!4d84.3831166!10e5!16s%2Fg%2F122h6119!3m5!1s0x398d032aaf47c20b:0x7bc3fb50270cc9cf!8m2!3d24.8193428!4d84.3756699!16s%2Fg%2F11t7nh3n6v?entry=ttu" className="link-secondary text-decoration-none" target="_blank" rel="noopener noreferrer">Aurangabad, Main GT Roan, Dharashala Road</a>
                                        </div>
                                    </div>
                                    <div className="d-flex mb-4">
                                        <div className="me-4 text-primary">
                                        ...
                                        <div>
                                            ...
                                            <p className="mb-0">
                                                <a className="link-secondary text-decoration-none" href="tel:+15057922430">7717736099</a>
                                            </p>
                                        </div>
                                    </div>
